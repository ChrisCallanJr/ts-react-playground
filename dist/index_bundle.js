...
var Message = /** @class */ (function (_super) {
    ...
    Message.prototype.render = function () {
        return (React.createElement("div", null, "You have got a message from " + this.props.from + ": " + this.props.body));
    };
    return Message;
}(React.Component));
...
ReactDOM.render(React.createElement(Message_1.default, { from: 'Chris', body: 'Greetings' }), document.getElementById('root'));
